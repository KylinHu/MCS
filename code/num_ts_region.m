...
clear
clc
data_path='/home/hxm_stu/WORK1/hcq/MCS/Result/run_globalTropical_86-05_1exp9/';
...
%file_name = strcat('record_num_exp9','.txt');
...
file_name = strcat('record_num_','exp3','.mat');
savefile = fullfile(output_path, file_name);
save(savefile,'time','num')
%fclose(fid); 
